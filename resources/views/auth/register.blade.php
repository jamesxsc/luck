...
<nav>
    <ul>
        <li><a href="..">&#x25c0;</a></li>
        <li id="current"><a href="">Register</a></li>
    </ul>
</nav>
<div class="header">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form">
                    ...
                    @endif
                    {!! Form::open(array('route' => 'auth.register', 'data-parsley-validate' => '')) !!}
                    {{ Form::label('name', 'Name:') }}
                    <br>
                    {{ Form::text('name', null, array('class' => 'form-group required', 'required' => '',
                            'placeholder' => 'Luck Smith')) }}
